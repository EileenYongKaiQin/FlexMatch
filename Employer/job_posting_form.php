...
<body>
    ...
    <div class="content" id="content">
        <form id="jobPostingForm" action="#" method="post">
            ...
            <button type="submit" class="btn btn-success btn-block btn-lg">Create Job Posting</button>
        </form>
        ...
        <div class="text-center mt-5">
            <img src="https://via.placeholder.com/600x300.png?text=Job+Search+Image" alt="Job Search" class="img-fluid">
        </div>
    </div>
